o2.xApplication.systemconfig.LP = {
    ...
    "permissionDenied": "ຊື່ຜູ້ໃຊ້ປະຈຸບັນຍັງບໍ່ໄດ້ຮັບອະນຸຍາດ，ທ່ານຕ້ອງສອບຖາມຜູ້ຈັດການລະບົບ",

    "yes": "ແມ່ນ",
    "no": "ບໍ່",
    "uploadInfo": "ລາກໄຟລ໌ມາບ່ອນນີ້，ຫຼືຄິກອັບໂຫຼດທີ່ນີ້",

    "baseConfig": "ຕັ້ງຄ່າທົ່ວໄປ",
    "systemInfo": "ຂໍ້ຄວາມ",
    "uiConfig": "ກນຕອບໂຕ້",
    "componentDeploy": "ອົງປະກອບ",
    "resourceDeploy": "ໃຊ້ຊັບພະກອນ",
    "serviceDeploy": "ບໍລິການ",

    "securityConfig": "ຄວາມປອດໄພ",
    "passwordConfig": "ລະຫັດ",
    "loginConfig": "ເຂົ້າລະບົບ",
    "ssoConfig": "ເຂົ້າສູ່ລະບົບ",
    "ternaryManagement": "3ຄົນບໍລິຫານ",

    "serverConfig": "ບໍລິການ",
    "serversConfig": "ເຊີເວີ",
    "centerServer": "ສູນກາງບໍລິການ",
    "appServer": "ບໍລິການ",
    "webServer": "ບໍລິການ Web",
    "databaseServer": "ຖານຂໍ້ມູນ",
    "storageServer": "ຄວາມຈຳ",
    "cacheConfig": "Cache",
    "clusterConfig": "ກຸ່ມ",
    "orgConfig": "ອົງກອນ",
    "processConfig": "ຂະບວນການ",
    "cloudConfig": "ເມກ",
    "dumpConfig": "ສຳຮອງຂໍ້ມູນ",
    "worktimeConfig": "ເວລາເຮັດວຽກ",

    "messageConfig": "ຂໍ້ຄວາມ",
    "msgTypeConfig": "ປະເພດ",
    "pushConfig": "Push ຂໍ້ຄວາມ",
    "mailConfig": "ເມວ",
    "smsConfig": "ຂໍ້ຄວາມສັ້ນ",
    "mqConfig": "ແຖວຂໍ້ຄວາມ",

    "queryIndexConfig": "ດັດຊະນີ",


    "mobileConfig": "ຕັ້ງຄ່າມືຖື",
    "connectConfig": "ເຊື່ອມຕໍ່",
    "appConfig": "ຕັ້ງຄ່າAPP",
    "moduleConfig": "ໂມດູູນ",
    "iconConfig": "icon",
    "ddConfig": "ding ding",
    "wechatConfig": "wechat",
    "welinkConfig": "welink",
    "appTools": "ເຄື່ອງມື APP",
    "integrationConfig": "ຮວບຮ່ວມ",
    ...
    "_systemInfo": {
        "title": "ຂໍ້ມູທົ່ວໄປ",
        "systemName": "ຊື່ລະບົບ",
        "systemNameInfo": "ຊື່ລະບົບຂອງເຈົ້າ，ມັນຈະປາກົດຢູ່ໃນຫນ້າເຂົ້າສູ່ລະບົບແລະຊື່ເລື່ອງຂອງໜ້າບາວເຊີ",
        "systemSubTitle": "ຫົວຂໍ້",
        "systemSubTitleInfo": "ຫົວຂໍ້ຂອງທ່ານ，ມັນຈະປາກົດຢູ່ໃນຫນ້າເຂົ້າສູ່ລະບົບ",
        "systemVersion": "ເວີຊັ້ນປະຈຸບັນ",
        "systemVersionInfo": "ເວີຊັ້ນປະຈຸບັນ",
        "baseInfo": "ຂໍ້ມູນເບື້ອງຕົ້ນ",
        "systemStatus": "ສະຖານະ",
        "moduleStatus": "ສະຖານະໂມດູນ",
        "language": "ພາສາ",
        "languageInfo": "ຕັ້ງຄ່າພາສາ",
        "languageValues": {
            "zh-CN": "ພາສາຈີນ",
            "en": "English",
            "es": "español",
        ...
        "running": "ດຳເນີນການ",
        "stop": "ຢຸດໃຊ້ງານ",
        "enable": "ເປີດໃຊ້ງານແລ້ວ",

        "server": "ເຊີເວີ",
        "node": "ໂນດ",
        "serverInfo": "ຂໍ້ມູນ",
        "webServer": "ເຊີເວີWEB",
        "appServer": "ແອັບເຊີເວີ",
        "centerServer": "ສູນກາງເຊີເວີ",
        "dataServer": "ຂໍ້ມູນ",
        "storageServer": "ຄວາມຈຳ",
        "dataNode": "ຂໍ້ມູນໂນດ",
        "databaseUrl": "ຖານຂໍ້ມູນ URL",

        "byModule": "ຕາມໂມດູນ",
        "byServer": "ຕາມເຊີເວີ",

        "storageNode": "ເກັບຮັກສາຟາຍ",
        ...
        "serverData": {
            ...
            "proxyHost": "(proxyHost)",
            "proxyPort": "(proxyPort)",
            "requestLogEnable": "ເປີດໃຊ້ງານ http",
            "requestLogBodyEnable": "ບັນທຶກເນື້ອໃນBody",
            "requestLogRetainDays": "ມື້ເກັບບັນທຶກຮັກສາ",
            "sslEnable": "ເປີດໃຊ້ SSL(sslEnable)",
            // "statEnable": "启用Druid",

            "cacheSize": "ຂະໜາດ(cacheSize)",
            "includes": "ລວມ(includes)",
            "excludes": "ແຍກ(excludes)",
            "jmxEnable": "ເປີດໃຊ້JMX(jmxEnable)",
            "lockTimeout": "ໝົດເວລາ(lockTimeout)",
            "logLevel": "ລະດັບ(logLevel)",
            "maxIdle": "ຄ່າສູງສຸດ(maxIdle)",
            "maxTotal": "ຈຳນວນສູງສຸດ(maxTotal)",
            "slowSqlMillis": "ເກນ SQLຊ້າ(slowSqlMillis)",
            "statFilter": "ເປີດໃຊ້ງານຄຳສັ່ງDruid(statFilter)",
            "tcpPort": "TCP(tcpPort)",
            "webPort": "WEB(webPort)"
        },
        "storageData": {
            "port": "ftp(port)",
            "sslEnable": "ເປີດໃຊ້SSL(sslEnable)",
            "name": "ຊື່(name)",
            "passivePorts": "(passivePorts)",
            "prefix": "ຄຳນຳໜ້າ(prefix)",
            "deepPath": "ນຳໃຊ້(deepPath)"
        },
        "storageAccounts": {
            "protocol": "ຂໍກຳນົດ",
            "username": "ໂມດູນ",
        ...
        "moduleData": {
            "node": "ບໍລິການໂນດ",
            "contextPath": "ແບ່ງຂັ້ນ",
            "port": "ບໍລິການport",
            "sslEnable": "ເປີດໃຊ້SSL",
            "proxyHost": "proxy Host",
            "proxyPort": "proxy Port",
            "reportDate": "ເວລາລາຍງານລ້າສຸດ",
            "moduleName": "ຊື່ໂມດູນ",
            "className": "ຫ້ອງ"
    ...
    "_component": {
        "open": "ເປີດ",
        "edit": "ແກ້ໄຂ",
        "uninstall": "ຖອນການຕິກຕັ້ງ",

        "deploy": "ນຳໃຊ້",

        "removeComponentTitle": "ຢືນຢັນຖອນການຕິດຕັ້ງ",
        "removeComponent": "ເຈົ້າແນ່ໃຈຕ້ອງການຖອນການຕິດຕັ້ງ：{name} ບໍ່？",
        "removeComponentOk": "ຖອນສຳເລັດ",

        "deploySuccess": "ນຳໃຊ້ສຳເລັດ",

        "selectIcon": "ເລືອກIcon",
        "clearIcon": "ລ້າງIcon",

        "name": "ຊື່",
        "title": "ຫົວຂໍ້",
        "path": "ເສັ້ນທາງ",
        "urlPathInfo": "ເຈົ້າສາມາດຜ່ານ“@url:”ເພີ່ມເສັ້ນທາງເປັນ URL ຂອງຫນ້າເວັບ，ເຊັ່ນ“@url:http://www.bing.com”",
        "visible": "ສາມາດເຫັນ",
        "allowList": "ລາຍການສາມາດເຂົ້າເຖິງໄດ້",
        "denyList": "ປະຕິເສດການເຂົ້າເຖິງລາຍການ",
        "icon": "ອົງປະກອບ",

        "upload": "ອັບໂຫຼດ",
        "uploadWarn": "ອັບໂຫຼດ zip，ຟາຍເກົ່າຈະຖືກແທນທີ່，ກະລຸຸນາລະມັດລະວັງ！",

        "componentDataError": "ຊື່、ເສັ້ນທາງແລະຫົວຂໍ້ບໍ່ສາມາດວ່າງໄດ້"
    },
    "_resource": {
        "webResource": "ປັບໃຊ້ຊັບພະຍາກອນWeb",
        "webResourceInfo": "Webເຈົ້າສາມາດໃຊ້ຊັບພະຍາກອນ，ອັບໂຫຼດຟາຍຕົ້ນສະບັບຫຼືຟາຍzip，ມັນຈະຖືກນຳໃຊ້ກັບລະບົບWebເຊີເວ，ສາມາດຜ່ານໂດຍ Http ເພື່ອເຂົ້າເຖິງລະບົບ。",
        "serviceResource": "ກຳນົດຊັບພະຍາກອນເອງ",
        "serviceResourceInfo": "ທ່ານສາມາດປັບໃຊ້ໂຄງການແບບກຳນົດເອງທີ່ທ່ານພັດທະນາໄດ້ທີ່ນີ້，ຫຼັງອັບໂຫຼດຊຸດjarຫຼືຊຸດwar。ຈຳເປັນຕ້ອງເລີ່ມຕົ້ນໃໝ່ຫຼັງຈາກປັບໃຊ້。",

        "componentResource": "ອົງປະກອບ",
        "componentResourceInfo": "ອົງປະກອບ O2OA ທີ່ພັດທະນາແບບກຳນົດເອງຂອງເຈົ້າ，ຫຼືໄດ້ຮັບສ່ວນປະກອບຈາກທາງການ, ທ່ານສາມາດ ນຳ ໃຊ້ພວກມັນໄດ້ທີ່ນີ້。ອົງປະກອບO2OA ແມ່ນເປັນ“x_component_{ຊື່}”ຂອງໂຟເດຫຼືຟາຍzip。ສໍາລັບລາຍລະອຽດເພີ່ມເຕີມກະລຸນາກວດສອບ：<a href='https://www.o2oa.net/develop.html' target='_blank'>O2OA官方社区。</a>",

        "upload": "ອັບໂຫຼດ",
        "webUploadWarn": "ອັບໂຫຼດຟາຍເພື່ອທີ່ຈະນຳປັບໃຊ້，ໄຟລ໌ zip ຈະຖືກບີບອັດອັດຕະໂນມັດ",
        "serviceUploadWarn": "ອັບໂຫຼດຊຸດjarຫຼືຊຸດwar ",

        "overwrite": "ວິທີການ",
        "overwriteFalse": "ລົບຫຼັງອັບໂຫຼດ：ລຶບໄຟລ໌ ແລະໂຟນເດີທີ່ມີຊື່ດຽວກັນຫຼັງອັບໂຫລດ。",
        "overwriteTrue": "ປົກປິດ：ທັບໄຟລ໌ ແລະໂຟນເດີໂດຍກົງດ້ວຍຊື່ດຽວກັນ。",

        "deployPath": "ເສັ້ນທາງ",
        "deployPathInfo": "ຖ້າໃຊ້ໄຟລ໌ zip，ເສັ້ນທາງສາມາດຫວ່າງເປົ່າ；ການນຳໃຊ້ໄຟລ໌ດຽວຕ້ອງລະບຸເສັ້ນທາງການນຳໃຊ້。ເຊັ່ນ：/myWebResource/subPath",

        "noDeployFile": "ກະລຸນາເລືອກໄຟລ໌ທີ່ຈະນຳໃຊ້ກ່ອນ",
        "deploySuccess": "ປັບໃຊ້ສຳເລັດ",

        "notWebResource": "<span style='color: red'>ເຊີບເວີປັດຈຸບັນບໍ່ອະນຸຍາດໃຫ້ນຳໃຊ້ຊັບພະຍາກອນເວັບ，ທ່ານສາມາດເປີດໃຊ້ງານນີ້ໃນ Server Configuration-Server Tasks</span>",
        "notServiceResource": "<span style='color: red'>ເຊີບເວີປັດຈຸບັນບໍ່ອະນຸຍາດໃຫ້ນຳໃຊ້ front-end ເພື່ອນຳໃຊ້ການບໍລິການແບບກຳນົດເອງ，ທ່ານສາມາດເປີດໃຊ້ງານນີ້ໃນ Server Configuration-Server Tasks</span>"
    },
    "_uiConfig": {
        "baseConfig": "ຕັ້ງຄ່າທົ່ວໄປ",
        "menuConfig": "ຕັ້ງຄ່າເມນູຫຼັກ",
        "lnkConfig": "ຕັ້ງຄ່າແຖບດ້ານຂ້າງ",
        "userConfig": "ຕັ້ງຄ່າ່່ການໂຕ້ຕອບຜູູ້້ໃຊ້",

        "openStatus": "ເຂົ້າໄປໃນລະບົບ",
        "openStatusInfo": "ທຸກໆຄັ້ງທີ່ທ່ານເຂົ້າສູ່ລະບົບ O2OA，ໂດຍຄ່າເລີ່ມຕົ້ນ, ແອັບພລິເຄຊັນທີ່ເປີດໃນເວລາທີ່ທ່ານອອກຈາກລະບົບຄັ້ງສຸດທ້າຍ，ເຈົ້າສາມາດປຽ່ນຮູບແບບການເຮັດວຽກນີ້ໄດ້。",
        "openStatusCurrent": "ວ່າງຕຳແໜ່ງຂອງແອັບທີ່ເປີດ ແລະເປີດຄັ້ງປະຈຸບັນເປັນສະຖານະເມື່ອອອກຈາກລະບົບຄັ້ງລ້າສຸດ（ຄ່າເລີ່ມຕົ້ນ）",
        "openStatusApp": "ເປີດແອັບທີ່ທ່ານອອກຈາກລະບົບຄັ້ງສຸດທ້າຍ，ແລະໜ້າຫຼັກເປັນໜ້າແອັບປະຈຸບັນ",
        "openStatusIndex": "ເປີດໜ້າຫຼັກເທົ່ານັ້ນ",

        "skin": "ພື້ນຜິວ",
        "skinConfig": "ອະນຸຍາດໃຫ້ແປງພື້ນຜິວ",
        "skinConfigInfo": "ອະນຸຍາດໃຫ້ຜູ້ໃຊ້ປັບແຕ່ງພື້ນຜິວຂອງລະບົບ",
        "skinDefault": "ພື້ນຜິວເລີ່ມຕົ້ນ",
        "skinDefaultInfo": "ຕັ້ງຄ່າສີຜິວເລີ່ມຕົ້ນ",
        "scaleConfig": "ອະນຸຍາດປັບຂະໜາດ",
    ...
    "_messageConfig": {
        ...
        "selectConsumer": "选择通道",
        "addTmpConsumer": "ເພີ່ມຊ່ອງ",

        "addMessageType": "ເພີ່ມປະເພດຂໍ້ຄວາມ",
        "newMessageData": {
            "key": "ID ຂໍ້ຄວາມ",
            "description": "ອະທິບາຍ"
        },
